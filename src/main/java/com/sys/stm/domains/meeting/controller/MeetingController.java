...
//    public ApiResponse<String> createMeeting(@RequestBody MeetingCreateRequest request){
//        Long memberId = 1L;
//
//        meetingService.createMeeting(request,memberId);
//
...
//    }
    ...
    public ApiResponse<String> createMeeting(
        ...
        MeetingCreateRequest request = null;

        try {
            request = mapper.readValue(meetingDataJson, MeetingCreateRequest.class);
